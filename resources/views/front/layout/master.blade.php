                  ...
                  <div class="select-items">
                    <table>
                      <tbody>
                        <tr>
                          <td class="si-pic">
                            <img src="front/img/select-product-1.jpg" alt="" />
                          </td>
                          <td class="si-text">
                        ...
                        <tr>
                          <td class="si-pic">
                            <img src="front/img/select-product-2.jpg" alt="" />
                          </td>
                          <td class="si-text">
                            <div class="product-selected">
                              <p>$60.00 x 1</p>
        ...
        <div class="nav-depart">
          <div class="depart-btn">
            ...
            <ul class="depart-hover">
              ...
              <li><a href="#">Accessories?shore</a></li>
      ...
      <div class="row">
        <div class="col-lg-3">
          <div class="footer-left">
            ...
            <ul>
              <li>1A Phan Thanh- Da Nang</li>
              <li>Phone: +84001000101</li>
              <li>Emai: jqdjsdj@kdkaskd</li>
            </ul>
            <div class="footer-social">
              <a href="#"><i class="fa fa-facebook"></i></a>
              <a href="#"><i class="fa fa-instagram"></i></a>
              <a href="#"><i class="fa fa-twitter"></i></a>
              <a href="#"><i class="fa fa-printerest"></i></a>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4">
          <div class="newslatter-item">
            <h5>Joint Our Newsletter Now</h5>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="copyright-text">
              ...
              <a href="https://Hirogo.net" target="_blank"></a>
            </div>
