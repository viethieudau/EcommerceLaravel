          ...
          <div class="place-order">
            ...
            <div class="order-total">
              <ul class="order-table">
                ...
                <li class="fw-nomal">{{ $cart->name}} x {{ $cart->qty}}<span>{{ $cart->price}}*{{ $cart->qty}}</span></li>
                @endforeach
                <li class="fw-nomal">Subtotal<span>${{ $subtotal }}</span></li>
