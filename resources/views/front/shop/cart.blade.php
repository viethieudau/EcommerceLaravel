        ...
        <div class="cart-table">
          <table>
            ...
            <tbody>
              ...
              <tr>
                <td class="card-pic first-row"><img style="height:170px" src="front/img/products/{{ $cart->options->images[0]->path }}" alt="" /></td>
